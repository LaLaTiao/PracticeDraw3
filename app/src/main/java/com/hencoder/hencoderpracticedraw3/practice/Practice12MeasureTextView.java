...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float mWidth1 = paint1.measureText(text1);
        float mWidth2 = paint2.measureText(text2);
        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + mWidth1, 200, paint2);
        canvas.drawText(text3, 50 + mWidth1+mWidth2, 200, paint1);
    }
}
